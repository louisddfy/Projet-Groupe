...
<body class="min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-200 flex flex-col items-center justify-start text-gray-900">
  ...
  <header class="w-full bg-white shadow-lg py-4 px-6 flex justify-between items-center">
    ...
    <div class="w-full max-w-4xl mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <a href="categorie.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">✚</div>
            <span class="font-semibold text-gray-800">Ajout de Catégorie</span>
        </a>
        
    </div>

     <div class="w-full max-w-4xl mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <a href="listcat.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">📋</div>
            <span class="font-semibold text-gray-800">Liste des Catégories</span>
        </a>

        <a href="listproduit.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">📦</div>
            <span class="font-semibold text-gray-800">Liste des Produits</span>
        </a>

         <a href="listvendeur.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">🧑‍🧒</div>
            <span class="font-semibold text-gray-800">Liste des Vendeurs</span>
        </a>
        <a href="signalements.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">🚨</div>
            <span class="font-semibold text-gray-800">Signalement</span>
        </a>
        <a href="litiges.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">⚖️</div>
            <span class="font-semibold text-gray-800">Gestion des Litiges</span>
        </a>
        <a href="historique_litiges.php" class="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center justify-center hover:shadow-2xl transition duration-300">
            <div class="text-4xl mb-2">📜</div>
            <span class="font-semibold text-gray-800">Historique des Litiges</span>
        </a>
